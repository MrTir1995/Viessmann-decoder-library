 ...
 * Provides Arduino-like API for Windows applications
 */

#pragma once
#ifndef ARDUINO_WINDOWS_H
#define ARDUINO_WINDOWS_H
...
// F() macro for compatibility (no-op on Windows)
#define F(string_literal) (string_literal)

#endif // ARDUINO_WINDOWS_H
